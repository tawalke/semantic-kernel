...
class MilvusMemoryStore(MemoryStoreBase):
    ...
    _logger: Logger
    _milvus_client
    _milvus_schema: List[FieldSchema] = []

    def __init__(self, logger: Optional[Logger] = None) -> None:
        self._store = {}
        self._logger = logger or NullLogger()
        """Initializes a new instance of the MilvusMemoryStore class.
        ...
        self._milvus_schema = [
            FieldSchema(name="collectionkey", dtype=DataType.INT64, is_primary=True, auto_id=True),
            FieldSchema(name="payload", dtype=DataType.STRING),
    ...
    async def create_collection_async(self, collection_name: str) -> None:
        ...
        collection_schema = CollectionSchema(self._milvus_schema, "New collection created from Semantic Kernel")
        Collection(collection_name, collection_schema)
